...
import animation_lk30aoqe from "public/assets/animation_lk30aoqe.json"

export function Footer() {
  return (
        <footer className=" bg-gray rounded-lg shadow text-gray-light m-4">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <Link href="/" className="-m-1.5 p-1.5">
                            ...
                            <Lottie
                                animationData={animation_lk30aoqe}
                                height={70}
                                width={70}
                                className="lottie"
                            />
